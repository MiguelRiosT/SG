...
class Crosshair:
    ...
    def draw(self, surface):
        pygame.draw.line(surface, self.color, (self.center[0] - self.length, self.center[1]), (self.center[0] + self.length, self.center[1]), self.thickness)
        pygame.draw.line(surface, self.color, (self.center[0], self.center[1] - self.length), (self.center[0], self.center[1] + self.length), self.thickness)
